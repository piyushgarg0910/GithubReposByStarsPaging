...
/**
 * Data transfer object for items in the github api response from the network
 *
 * @author Piyush Garg
 */
data class ItemsResponseModelDTO(
    @SerializedName ("id") val id: Int,
    @SerializedName("node_id") val nodeId: String,
    @SerializedName("name") val name: String,
    @SerializedName("full_name") val fullName: String,
    @SerializedName("private") val isPrivate: Boolean,
    @SerializedName("owner") val owner: OwnerResponseModelDTO,
    ...
    @SerializedName("license") val license: LicenseResponseModelDTO,
